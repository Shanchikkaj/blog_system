...
<body style="background-image:url(https://i.pinimg.com/564x/04/e5/e3/04e5e3930e5fbaa0c7bea5e2c921472d.jpg);background-size: cover">
...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="flex-btn">
            <a href="../users/user_likes.php" class="option-btn">likes</a>
            <a href="../users/user_comments.php" class="option-btn">comments</a>
         </div>
         <?php
            }else{
         ?>
      ...
      <div class="box">
         ...
         ?>
            <a href="../author/author_posts.php?author=<?= $fetch_authors['name']; ?>" class="links"><?= $fetch_authors['name']; ?></a>
            <?php
            }
         }else{
         ...
         ?>  
         <a href="../author/authors.php" class="btn">view all</a>
         </div>
      </div>
   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <div class="post-admin">
            ...
            <div>
               <a href="../author/author_posts.php?author=<?= $fetch_posts['name']; ?>"><?= $fetch_posts['name']; ?></a>
         ...
         <a href="../users/view_post.php?post_id=<?= $post_id; ?>" class="inline-btn">read more</a>
         <a href="category.php?category=<?= $fetch_posts['category']; ?>" class="post-cat"> <i class="fas fa-tag"></i> <span><?= $fetch_posts['category']; ?></span></a>
         <div class="icons">
            <a href="../users/view_post.php?post_id=<?= $post_id; ?>"><i class="fas fa-comment"></i><span>(<?= $total_post_comments; ?>)</span></a>
