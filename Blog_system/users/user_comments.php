...
?>
   ...
   <form action="" method="POST">
      ...
      <div class="inline-option-btn" onclick="window.location.href = '../users/user_comments.php';">cancel edit</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         ?>
         <div class="post-title"> from : <span><?= $fetch_posts['title']; ?></span> <a href="../users/view_post.php?post_id=<?= $fetch_posts['id']; ?>" >view post</a></div>
         <?php
            }
         ?>
