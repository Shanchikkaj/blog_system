...
?>
   ...
   <form action="" method="POST">
      ...
      <div class="inline-option-btn" onclick="window.location.href = '../users/view_post.php?post_id=<?= $get_id; ?>';">cancel edit</div>
   </form>
   </section>
<?php
   }
...
<section class="comments-container">
   ...
   <div class="add-comment">
      ...
      <a href="../main/login.php" class="inline-btn">login now</a>
   </div>
   <?php
      }
   ?>
